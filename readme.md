...
❗️ Replace `mitkevichm92-a11y` with your GitHub username and copy the links to the `Pull Request` description:

- [DEMO LINK](https://mitkevichm92-a11y.github.io/layout_moyo-header/)
- [TEST REPORT LINK](https://mitkevichm92-a11y.github.io/layout_moyo-header/report/html_report/)
...
- [x]ogo is an image wrapped with a link
